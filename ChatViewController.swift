...
//     print ("*** chatScrollViewOffset, messageViewY, newY: \(chatScrollViewOffset, self.messageViewY, newY) ")
//            print ("*** self.chatScrollView.frame.size.height: \(self.chatScrollView.frame.size.height) ")
//            print ("*** self.chatScrollView.contentSize.height: \(self.chatScrollView.contentSize.height) ")
//            print ("*** self.chatScrollView.bounds.size.height: \(self.chatScrollView.bounds.size.height) ")
            ...
            if let m_value = snapshot.value {
                ...
                for (_, subjson) in json {
                    ...
                    if subjson["sender"].stringValue == fireUser?.email &&
                        subjson["recipient"].stringValue == recipientEmail {// если
                        ...
                        subjson["sender"].stringValue == recipientEmail {// если
                        self.messageArray.append(( dateFromString(date: subjson["date"].stringValue)!,
                                                                        subjson["message"].stringValue,
                                                                        subjson["sender"].stringValue))
