...
//   
    ...
    override func viewDidLoad() {
        ...
        if loadStatus.autoLogin != nil {
            
            txtLogin.text = loadStatus.autoLogin
            txtPassword.text = loadStatus.autoPass
        }
    ...
    @IBAction func btnSignUpPressed(_ sender: Any) {
        FIRAuth.auth()?.signIn(withEmail: self.txtLogin.text!, password: self.txtPassword.text!) { (user, error) in
            ...
            if error == nil {
                ...
                loadStatus.autoLogin = self.txtLogin.text
                loadStatus.autoPass = self.txtPassword.text
